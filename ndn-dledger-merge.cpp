...
const int NodesCnt = 9;
const int EntropyThreshold = 3;
...
main(int argc, char *argv[])
{
  ...
  // Finish Installation****************************************************
  Simulator::Schedule(Seconds(20.0), failLink, nodes.Get(4)->GetDevice(0));
  Simulator::Schedule(Seconds(120.0), upLink, nodes.Get(4)->GetDevice(0));
